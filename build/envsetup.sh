...
- fiimeremote:      Add git remote for matching fiime repository.
...
function fiimeremote()
{
    ...
    git remote rm fiime 2> /dev/null
    ...
    git remote add fiime https://android.googlesource.com/$PFX$PROJECT
    echo "Remote 'fiime' created"
}
...
function repopick() {
    T=$(gettop)
    $T/vendor/fiime/build/tools/repopick.py $@
}
